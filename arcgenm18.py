...
class Application(Frame):
  ...
  def createWidgets(self):
    ...
    self.SaveFile.grid(row=14, column=2)
  ...
  def SaveFile(self):
      ...
      f = open(homedir+"/linuxcnc/nc_files/arc.ngc","w") #opens file

      f.write(self.ArcCode.get())
